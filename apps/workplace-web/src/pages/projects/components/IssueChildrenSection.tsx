...
export function IssueChildrenSection({
  ...
  async function onAdd() {
    ...
    try {
      ...
      toast.success('SUBTASK 를 추가했습니다');
    } catch (e) {
      handleApiError(e, 'SUBTASK 추가에 실패했습니다');
    } finally {
      setAdding(false);
    }
  }
  ...
  return (
    <section
      aria-label="자식 SUBTASK"
      data-testid="issue-children-section"
      className="space-y-2"
    >
      <div className="flex items-center gap-2">
        <h3 className="text-sm font-medium">자식 SUBTASK</h3>
      ...
      {children.isLoading ? (
        ...
        <p className="text-xs text-muted-foreground">자식 SUBTASK 가 없습니다</p>
      ) : (
      ...
      >
        <Input
          ...
          placeholder="+ SUBTASK 추가 — 제목 입력 후 Enter"
          maxLength={200}
