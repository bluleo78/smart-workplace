...
public class WikiPageService {
  ...
  /**
   * #736 AI 생성 attribution 기록. {@link WikiAiService} 의 스트림 완료(delta 1개 이상 전달된 완료/취소/에러)
   * 지점에서 호출되는 유일한 기록 지점 — PUT 저장 경로에서는 기록하지 않는다(§3, 중복 기록 방지).
   * 권한/버전 체크 없이 컬럼 2개만 갱신하는 {@link WikiPageRepository#recordAiUsage} 를 그대로 위임.
   */
  @Transactional
