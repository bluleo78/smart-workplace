...
import com.workplace.jooq.tables.records.RefreshTokenRecord;
...
public class RefreshToken extends TableImpl<RefreshTokenRecord> {
    ...
    /**
     * The column <code>public.refresh_token.family_id</code>.
     */
    public final TableField<RefreshTokenRecord, UUID> FAMILY_ID = createField(DSL.name("family_id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("gen_random_uuid()"), SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<RefreshTokenRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_REFRESH_TOKEN_FAMILY_ID, Indexes.IDX_REFRESH_TOKEN_USER_ID);
    }
    ...
    public UserPath user() {
        if (_user == null)
            _user = new UserPath(this, Keys.REFRESH_TOKEN__REFRESH_TOKEN_USER_ID_FKEY, null);
