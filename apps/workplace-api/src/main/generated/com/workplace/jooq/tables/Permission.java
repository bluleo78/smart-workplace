...
import com.workplace.jooq.tables.records.PermissionRecord;
...
public class Permission extends TableImpl<PermissionRecord> {
     ...
     */
    public final TableField<PermissionRecord, String> CODE = createField(DSL.name("code"), SQLDataType.VARCHAR(50).nullable(false), this, "");
    ...
    /**
     * The column <code>public.permission.category</code>.
     */
    public final TableField<PermissionRecord, String> CATEGORY = createField(DSL.name("category"), SQLDataType.VARCHAR(50).nullable(false), this, "");

    /**
     * The column <code>public.permission.created_at</code>.
     */
    public final TableField<PermissionRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("now()"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.IDX_PERMISSION_CATEGORY);
    }
    ...
    public List<UniqueKey<PermissionRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.PERMISSION_CODE_KEY);
    }
    ...
    public PlatformRolePermissionPath platformRolePermission() {
        if (_platformRolePermission == null)
            _platformRolePermission = new PlatformRolePermissionPath(this, null, Keys.PLATFORM_ROLE_PERMISSION__PLATFORM_ROLE_PERMISSION_PERMISSION_ID_FKEY.getInverseKey());
    ...
    public PlatformRolePath platformRole() {
        return platformRolePermission().platformRole();
    }
