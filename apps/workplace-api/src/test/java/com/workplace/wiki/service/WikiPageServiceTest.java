...
class WikiPageServiceTest extends IntegrationTestBase {
  ...
  /**
   * #736: recordAiUsage 는 ai_last_used_at/ai_last_action 만 갱신하고 version/updated_at/updated_by 는
   * 그대로 둬야 한다 — version 을 올리면 뒤이은 자동저장이 낡은 version 으로 충돌 처리되는 회귀가 생긴다(§3).
   */
  @Test
