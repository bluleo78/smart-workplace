...
class IssueSetTypeTest extends IntegrationTestBase {
  ...
  void member_changes_type_records_history() {
    ...
    var issue =
        issueService.create(
            owner, p.key(), new CreateIssueRequest("t", null, null, null, null, null));
  ...
  void foreign_type_throws_400() {
    ...
    var issue =
        issueService.create(
            owner, pa.key(), new CreateIssueRequest("t", null, null, null, null, null));
  ...
  void create_with_explicit_type_uses_it() {
    ...
    var issue =
        issueService.create(
            owner, p.key(), new CreateIssueRequest("t", null, null, null, null, bug.id()));
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    pa.key(),
                    new CreateIssueRequest("t", null, null, null, null, foreignType.id())))
        .isInstanceOf(InvalidTypeForProjectException.class);
  }
}
