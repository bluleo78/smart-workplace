    ...
    var result =
        issueRepository.search(
            ...
            new IssueSearchQuery(
                null, List.of(), List.of(), false, List.of(), null, null, null, 30));
  ...
  void q_matches_title_or_body_ilike() {
    ...
    var result =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                "login", List.of(), List.of(), false, List.of(), null, null, null, 30));
  ...
  void status_csv_or_matching() {
    ...
    var result =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                null, List.of("IN_PROGRESS"), List.of(), false, List.of(), null, null, null, 30));
  ...
  void include_unassigned_matches_null_assignee() {
    ...
    var result =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                null, List.of(), List.of(), true, List.of(), null, null, null, 30));
  ...
  void assignee_ids_or_includes_unassigned() {
    ...
    var result =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                null, List.of(), List.of(s.userId), true, List.of(), null, null, null, 30));
  ...
  void cursor_paging_continues_after_first_page() {
    ...
    var page1 =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                null, List.of(), List.of(), false, List.of(), null, null, null, 2));
    ...
    var page2 =
        issueRepository.search(
            s.projectId,
            new IssueSearchQuery(
                null, List.of(), List.of(), false, List.of(), null, null, cursor, 2));
