...
class IssueParentServiceTest extends IntegrationTestBase {
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    p.key(),
                    new CreateIssueRequest("c", null, null, null, null, subId, null)))
  ...
  void non_subtask_create_with_parent_throws_400() {
    ...
    var parent =
        issueService.create(
            owner, p.key(), new CreateIssueRequest("parent", null, null, null, null, null, null));
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    p.key(),
                    new CreateIssueRequest("child", null, null, null, null, null, parent.number())))
  ...
  void subtask_create_with_subtask_parent_throws_400() {
    ...
    var sub1 =
        issueService.create(
            owner,
            p.key(),
            new CreateIssueRequest("s1", null, null, null, null, subId, task.number()));
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    p.key(),
                    new CreateIssueRequest("s2", null, null, null, null, subId, sub1.number())))
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    pb.key(),
                    new CreateIssueRequest("s", null, null, null, null, subIdB, 1)))
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    p.key(),
                    new CreateIssueRequest("e", null, null, null, null, epicId, parent.number())))
    ...
    assertThatThrownBy(
            () ->
                issueService.create(
                    owner,
                    p.key(),
                    new CreateIssueRequest("s", null, null, null, null, subId, epic.number())))
  ...
  void subtask_create_ok_sets_parent_and_response() {
    ...
    var child =
        issueService.create(
            owner,
            p.key(),
            new CreateIssueRequest("c", null, null, null, null, subId, parent.number()));
