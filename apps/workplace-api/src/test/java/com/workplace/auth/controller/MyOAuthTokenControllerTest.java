...
/**
 * /users/me/oauth-token — ApiKeyAuthenticationFilter 가 principal 을 Long 으로 세팅하는 흐름이 본질이라 mockMvc
 * 만으로는 재현 까다로움. 본 테스트는 인증 없이 4xx 만 검증하고 (실제 동작은 service 통합 테스트 + ai-agent nock 기반 테스트 + 수동 e2e 로
 * 갈음).
 */
